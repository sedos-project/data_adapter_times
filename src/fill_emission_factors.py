...
SCEN_EMISSION_FILE_PATH = "output_data/Scen_emission_all_tra.xlsx"
...
def main():
    ...
    process_groups = [
        ...
        "tra_rail_frei_1",
        "tra_rail_pass_1",
    ]  # Add more process groups as needed
    ...
    times_df = pd.read_pickle("output_data/times_df_tra.pkl")
    unique_processes = times_df["TechName"].unique()
    ind_processes = [
        process for process in unique_processes if process.startswith("tra")
    ]
