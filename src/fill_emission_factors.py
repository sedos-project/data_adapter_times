...
def main():
    ...
    process_groups = [
        ...
        "pow_timeseries_d",
        "pow_timeseries_de",
        "pow_timeseries_demand_a",
        "pow_timeseries_demand_al",
        "pow_timeseries_demand_at",
        "pow_timeseries_demand_b",
        "pow_timeseries_demand_ba",
        "pow_timeseries_demand_be",
        "pow_timeseries_demand_bg",
        "pow_timeseries_demand_c",
        "pow_timeseries_demand_ch",
        "pow_timeseries_demand_cy",
        "pow_timeseries_demand_cz",
        "pow_timeseries_demand_d",
        "pow_timeseries_demand_de",
        "pow_timeseries_demand_dk",
        "pow_timeseries_demand_e",
        "pow_timeseries_demand_ee",
        "pow_timeseries_demand_es",
        "pow_timeseries_demand_f",
        "pow_timeseries_demand_fi",
        "pow_timeseries_demand_fr",
        "pow_timeseries_demand_g",
        "pow_timeseries_demand_gb",
        "pow_timeseries_demand_gr",
        "pow_timeseries_demand_hr",
        "pow_timeseries_demand_hu",
        "pow_timeseries_demand_ie",
        "pow_timeseries_demand_is",
        "pow_timeseries_demand_it",
        "pow_timeseries_demand_lt",
        "pow_timeseries_demand_lu",
        "pow_timeseries_demand_lv",
        "pow_timeseries_demand_me",
        "pow_timeseries_demand_mk",
        "pow_timeseries_demand_mt",
        "pow_timeseries_demand_nl",
        "pow_timeseries_demand_no",
        "pow_timeseries_demand_pl",
        "pow_timeseries_demand_pt",
        "pow_timeseries_demand_ro",
        "pow_timeseries_demand_rs",
        "pow_timeseries_demand_se",
        "pow_timeseries_demand_si",
        "pow_timeseries_demand_sk",
        "pow_timeseries_dk",
        "pow_timeseries_e",
        "pow_timeseries_ee",
        "pow_timeseries_es",
    ...
    # Fetch and process data for individual processes (e.g., starting with 'pow')
    # Assuming times_df is pre-loaded or fetched from your initial pickle or Excel file
    times_df = pd.read_pickle("output_data/times_df_pow.pkl")
    unique_processes = times_df["TechName"].unique()
    pow_processes = [
        process for process in unique_processes if "pow_" in process.lower()
    ]

    # Skip processes that end with '_ag'
    pow_processes = [
        process for process in pow_processes if not process.endswith("_ag")
    ]
